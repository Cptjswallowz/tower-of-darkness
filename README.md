...
## Status (post-routecare reverse — WIP)

- **v0.1.10-routecare reversed:** CARE (REST|SHOP) guarantee on every Start→Boss path removed. Path rules match **v0.1.9-floor2** again (no new tagged release). Tag/release `v0.1.10-routecare` left in place for history.
...
- Path: **every Start→Boss path has ≥1 COMBAT** (v0.1.7 lock); **event cap ≤1** per floor; **no CARE guarantee**
