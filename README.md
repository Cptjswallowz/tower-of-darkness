...
## Status (v0.1.19-glyphs)

- **v0.1.19-glyphs:** Skill tile **glyphs** (24–32 dp) on combat bar + loadout; color = job (Brace green outline). Ashbrand blade only — no second glyph. Placeholder `glyph_*.png` (Art gen) (Art drop-in same names). No combat math / Wake / bodies / path / 2x / save / pip changes. **No tag.**
...
[Release v0.1.18-bodies](https://github.com/Cptjswallowz/tower-of-darkness/releases/tag/v0.1.18-bodies)
Direct: [tower-of-darkness-debug.apk](https://github.com/Cptjswallowz/tower-of-darkness/releases/download/v0.1.18-bodies/tower-of-darkness-debug.apk)
