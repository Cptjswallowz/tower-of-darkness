...
- **Route CARE (v0.1.10):** every Start→Boss path has ≥1 REST or SHOP (after combat lock, convert last non-COMBAT → REST); F1+F2
...
- Path: **every Start→Boss path has ≥1 COMBAT** and **≥1 CARE** (REST|SHOP); **event cap 1** per floor
...
Docs: `docs/floor2-v019.md`, `docs/wake-v014.md`, `docs/qa-gate-v015-path-2026-09-21.md`, `docs/qa-gate-v016-swaplock-2026-09-21.md`, `docs/qa-gate-v017-routefight-2026-09-22.md`, `docs/qa-gate-v018-shopwallet-2026-09-22.md`, `docs/qa-gate-v019-floor2-2026-09-22.md`, `docs/routecare-v0110.md`.
